INSERT INTO games (title, release_year, box_art, synopsis)
VALUES (
    "Super Mario Bros.",
    1985,
...
Then, to complete your quest, return the 8 Eyes to the Altar of Peace to await the return on the Great King, so that he may finish the rebuilding of Earth. Your reward will be the the eternal gratitude of all mankind!"
  ...
  (
    ...
    1986,
    "https://images.igdb.com/igdb/image/upload/t_cover_big/cixn5seyzqvvx61ycxga.jpg",
    NULL
  ),
  (
    "Abadox: The Deadly Inner War",
    1988,
    "https://images.igdb.com/igdb/image/upload/t_cover_big/co2cia.jpg",
  ...
  (
    "720 degrees",
    1986,
    "https://images.igdb.com/igdb/image/upload/t_cover_big/co1qly.jpg",
